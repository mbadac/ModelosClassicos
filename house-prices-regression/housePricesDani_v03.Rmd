---
title: "Regressão Linear - House Prices"
...
dtTest_features <- subset(dtTest, select = c(OverallQual, GarageCars))

predicao =  predict(modelo, data.frame(dtTest_features))
#predicao

dtTest = data.frame(cbind(dtTest, predicao))

write.csv(dtTest[, c("Id","predicao")], "resultado.csv", row.names=FALSE, quote=FALSE)
